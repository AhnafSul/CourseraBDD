...
public class ExcelWriter {
    ...
    public static void writeLanguageAndLevel(List<String> languageList, List<String> levelList, String fileName, String sheetNamePrefix, String header1, String header2) {
        Workbook workbook;
        Sheet sheet;
